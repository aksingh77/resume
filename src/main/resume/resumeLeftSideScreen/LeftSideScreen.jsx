        ...
        <>
            ...
            <div className="contactStyle">
                <div className="flex gap-4 items-center ">
                    <div className="image shadow-[1px_1px_12px_#000;] p-4 rounded-md">
                        <FontAwesomeIcon icon={['fas', 'envelope']} className="w-5 text-goldenColor" />

                    </div>
                    <div className="textField"><span className="contactText uppercase tracking-[1px] opacity-70 font-light">Email</span>
                        <p className='mt-[-6px]'>
                            <a href="mailto:samit5585@gmail.com">samit5585@gmail.com</a>
                        </p>
                    </div>
                </div>
                <div className="flex gap-4 items-center mt-8">
                    <div className="image shadow-[1px_1px_12px_#000;] p-4 rounded-md">
                        <FontAwesomeIcon icon={['fas', 'mobile']} className="w-5 text-goldenColor" />

                    </div>
                    <div className="textField"><span className="contactText uppercase tracking-[1px] opacity-70 font-light">Phone</span>
                        <p className='mt-[-6px]'>
                            <a href="tel:+917007115781">700 711 5781</a>
                        </p>
                    </div>
                </div>
                <div className="flex gap-4 items-start mt-8">
                    <div className="image shadow-[1px_1px_12px_#000;] p-4 rounded-md">
                        <FontAwesomeIcon icon={['fas', 'location-dot']} className="w-5 text-goldenColor" />
